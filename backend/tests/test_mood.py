...
def test_find_songs_for_party():
    """"Test the output of find_songs_for_party function
    to ensure It is a list"""
...
def test_find_songs_for_chill():
    """"Test the output of find_songs_for_chill function
    to ensure It is a list"""
...
def test_find_songs_for_workout():
    """"Test the output of find_songs_for_workout function
    to ensure It is a list"""
...
def test_find_songs_for_passion():
    """"Test the output of find_songs_for_passion function
    to ensure It is a list"""
...
def test_discover_random_song():
    """"Test the output of discover_random_song function
    to ensure It is a list"""
...
def test_find_songs_for_party_values():
    """Test the find_songs_for_party function to ensure
    it returns songs within the specified feature ranges."""
    songs_for_party = find_songs_for_party()
    random_song = random.choice(songs_for_party)
    song_in_dataset = spotify_songs[(spotify_songs['track_name'] ==
                                    random_song['track_name']) &
                                    (spotify_songs['track_artist'] ==
                                    random_song['track_artist'])].iloc[0]
...
def test_find_songs_for_chill_values():
    """Test the find_songs_for_chill function to ensure
    it returns songs within the specified feature ranges."""
    songs_for_chill = find_songs_for_chill()
    random_song = random.choice(songs_for_chill)
    song_in_dataset = spotify_songs.loc[(spotify_songs['track_name'] ==
                                        random_song['track_name']) &
                                        (spotify_songs['track_artist'] ==
                                        random_song['track_artist'])].iloc[0]
...
def test_find_songs_for_workout_values():
    """Test the find_songs_for_workout function to ensure
    it returns songs within the specified feature ranges."""
...
def test_find_songs_for_passion_values():
    """Test the find_songs_for_passion function to ensure
    it returns songs within the specified feature ranges."""
