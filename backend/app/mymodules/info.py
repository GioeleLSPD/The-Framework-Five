...
def genre_popularity():
    """
    Calculate and return the average popularity of subgenres based on
    Spotify songs.

    This function groups songs by their 'playlist_subgenre' and calculates the
    average popularity of tracks within each subgenre. The result
    is a dictionary
    where subgenres are keys and their corresponding average
    popularity is the value.

    Returns:
    dict: A dictionary with subgenres as keys and their average
    popularity as values."""
...
def get_song_count_by_genre():
    """
    Calculate and return the count of songs for each subgenre based
    on Spotify songs.

    This function counts the number of songs in each 'playlist_subgenre'
    category
    within the 'spotify_songs' DataFrame and returns
    the result as a dictionary.

    Returns:
    dict: A dictionary with subgenres as keys and the count of
    songs as values."""
...
def artist_songs():
    """
    Calculate and return the count of songs for each artist based
    on Spotify songs.

    This function counts the number of songs for each unique artist in
    the 'spotify_songs'
    DataFrame and returns the result as a dictionary. The dictionary is
    sorted alphabetically
    by artist names.

    Returns:
    dict: A dictionary with artists as keys and their corresponding song
    counts as values."""
...
def count_songs():
    ...
    This function computes the total number of songs in the 'spotify_songs'
    DataFrame
...
def get_songs_by_artist(artist_name):
    """
    Retrieve and return a list of songs by a specific artist from
    the Spotify songs dataset.

    This function filters the 'spotify_songs' DataFrame based
    on the provided 'artist_name'
    and returns a list of song names associated with the specified artist.

    Args:
    artist_name (str): The name of the artist for whom the song list
    is to be retrieved.
