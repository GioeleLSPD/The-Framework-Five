...
def genre_popularity():
    """Return a dictionary with subgenres as keys and their average popularity
    as values"""
...
def get_song_count_by_genre():
    """Return a dictionary with subgenres as keys and the count
    of songs as values"""
...
def artist_songs():
    """Return a dictionary with artists as keys
    and their song counts as values"""
