...
def get_songs_by_mood(mood_name: str):
    ...
    This endpoint is designed to return a list of songs associated with a specific mood.
...
def get_info(info_g: str):
    ...
    This endpoint is designed to retrieve and return music-related information based on the specified category.
...
def artist_song_list(artist_name: str):
    ...
    This endpoint is designed to retrieve and return a list of songs by a specific artist.
    ...
    list: A list of dictionaries representing songs by the specified artist.
          Each dictionary contains information about a song, including 'track_name' and 'track_artist'."""
